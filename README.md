...
결과물  
입력이미지  
<img src="/test/scantest.jpg" width="70%" height="70%" title="scantest" alt="scantest"></img><br/>
종이전체가 포함된 사진파일이다.

출력이미지1 scan  
<img src="/test/scantest_result.png" width="70%" height="70%" title="scantest_result" alt="scantest_result"></img><br/>
종이의 테두리를 따라 사진을 자르고 이진화하였다.
출력이미지2 sample_c    
<img src="/test/scantest_result_c.png" width="70%" height="70%" title="scantest_result_c" alt="scantest_result_c"></img><br/>
